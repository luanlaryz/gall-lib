...
| Reasoning tools | Conjunto de tools auxiliares para raciocinio estruturado e etapas intermediarias. | Nao | P2 | `tool/reasoning` | Adiado | Medio | A `Spec 041` define `think`, `analyze` e o toolkit interno `reasoning_tools`; a implementacao continua adiada fora da v1 e sem exposicao publica ate promocao explicita. |
